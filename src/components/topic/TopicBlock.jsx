    ...
    >
      ...
      <div className="sticky top-28 z-10 mb-4 flex flex-wrap items-start justify-between gap-3 border-b border-surface-200 bg-white py-2 dark:border-surface-800 dark:bg-surface-900">
        <div className="min-w-0 flex-1">
          <Link
            to={`/topic/${topic.slug}`}
            className="text-lg font-bold text-surface-900 hover:text-primary-600 dark:text-white dark:hover:text-primary-400 sm:text-xl"
          >
            {topic.title}
          </Link>
          {user ? (
      ...
      <hr className="mb-5 border-surface-200 dark:border-surface-800" />
